...
CREATE TABLE `restaurant` (
  ...
  CONSTRAINT `city_check` CHECK (`city` = 'Calgary' or 'Vancouver' or 'Toronto'),
  CONSTRAINT `phone_check` CHECK (`phone_number` = '[0-9][0-9][0-9]-[0-9][0-9][0-9]-[0-9][0-9][0-9][0-9]')
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin;
/*!40101 SET character_set_client = @saved_cs_client */;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `client_login`(token_input varchar(100),username_input varchar(100),password_input varchar(100))
    MODIFIES SQL DATA
begin
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `delete_restaurant`(token_input varchar(100))
begin
	DELETE FROM foodie.restaurant WHERE id=(select restaurant_id from restaurant_session where token=token_input);
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `get_restaurant`(token_input int(10))
begin
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `menu_edit`(token_input varchar(100),description_input varchar(100),image_url_input varchar(2000),name_input varchar(80),price_input decimal(10,2))
    MODIFIES SQL DATA
begin
...
begin
	...
	values (now(),first_name_input,last_name_input,image_url_input,username_input,password_input);
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `new_restaurant`(email_input varchar(150),name_input varchar(150),password_input varchar(100),address_input varchar(150),phone_number_input varchar(80),bio_input varchar(250),city_input varchar(30),profile_url_input varchar(2000),banner_url_input varchar(2000),token_input varchar(100))
    MODIFIES SQL DATA
begin
	...
	select rs.restaurant_id,rs.token from restaurant_session rs where rs.id = last_insert_id();  
	commit;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,STRICT_TRANS_TABLES,ERROR_FOR_DIVISION_BY_ZERO,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `restaurant_edit`(token_input varchar(100),email_input varchar(150), name_input varchar(150), password_input varchar(100), address_input varchar(150), phone_number_input varchar(80), bio_input varchar(250), city_input varchar(30), profile_url_input varchar(2000), banner_url_input varchar(2000))
    MODIFIES SQL DATA
begin
	UPDATE foodie.restaurant SET 
	email=ifnull(email_input,email), password=ifnull(password_input,password),
...
begin
	...
	select rs.client_id,rs.token from rlient_session rs where rs.token = token_input;
end ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
